...
This analysis utilizes open-sourced data from kaggle. [Online Retail Dataset](https://www.kaggle.com/datasets/thedevastator/online-retail-transaction-data/data) The dataset contains online retail transaction records from a UK-based online retail business. A Business health analysis was conducted to assess the company’s long-term sustainability.
